      ...
      <>
        ...
        <main className={`${styles.mainContainer}`}>
          ...
          <div className={`${styles.midColumnContainer} ${styles.background}`}>
            {isMobile ? (
              <>
                <text className={styles.introTitleContainerMobile}>E-COPS를 소개합니다!</text>
                <text className={styles.introContainerMobile}>
                  E-COPS(EWHA-CONTROL OF PROGRAM SECURITY)는 <br />
                  이화여대 학생이라면 누구나 참여할 수 있는 <br />
                  이화여자대학교 대표 사이버보안 동아리입니다. <br />
                  함께 정보 보안을 공부하며 보안 전문가로 성장해 나가는 것을 <br />
                  목표로 하고 있습니다.
                  <br /> E-COPS는 이화여대 경력개발센터 우수 동아리에 이름을 올렸으며, 현재 이화여자대학교 인재개발원
                  커리어클럽, <br />
                  보안 연합 커뮤니티 IncogNITO, SUA, hspace에 소속되어 <br />
