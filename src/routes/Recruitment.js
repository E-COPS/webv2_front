            ...
            <text className = {styles.headerText}>IS COMING!</text>
              ...
              <div className={styles.rowContainer}>
                <div className={styles.circleBox}>
                  ...
                  <text className={styles.contentWhiteText}>
                    02.20(Mon)~02.28(Tue)<br></br>28일 23시 59분 마감
                  </text>
                </div>
                <div className={styles.circleBox}>
                  <div className={styles.miniCircle}></div>
                  ...
                  <text className={styles.contentWhiteText}>03.01(Wed)</text>
                </div>
                <div className={styles.circleBox}>
                  <div className={styles.miniCircle}></div>
                  <div className={styles.miniCircle2}></div>
                  ...
                  <text className={styles.contentWhiteText}>
                    03.02(Thu)~03.04(Sat)<br></br>개별 연락 예정
                  </text>
                </div>
                <div className={styles.circleBox}>
                  <div className={styles.miniCircle}></div>
                  <div className={styles.miniCircle2}></div>
                  <text className={styles.contentTitleText}>&nbsp;&nbsp;&nbsp;최종 발표</text>
                  <text className={styles.contentWhiteText}>03.05(Sun)</text>
                </div>
              </div>
              {/* content 3 - 자주 묻는 질문 */}
              <div className={styles.content3Container}>
              ...
              <div className={styles.columnContainer}>
                ...
                <div className={styles.toggle}>
                  <button className={styles.btnRow} onClick={() => setBtnClick_1(!btnClick_1)}>
                    <text className={styles.contentBigText}>
                      비기너로 지원하고 싶은데 경험이 하나도 없어요. 지원해도 괜찮을까요?
                    </text>
                    <text className={styles.contentBigText}>
                      {/* 버튼 클릭 여부에 따라 모양 다르게*/}
                      {btnClick_1 ? '▲' : '▼'}
                ...
                {/* 질문 2 */}
                <div className={styles.toggle}>
                  <button className={styles.btnRow} onClick={() => setBtnClick_2(!btnClick_2)}>
                    <text className={styles.contentBigText}>챌린저 분야는 항상 같나요?</text>
                    <text className={styles.contentBigText}>{btnClick_2 ? '▲' : '▼'}</text>
                  </button>
                  {btnClick_2 ? (
                    <div className={styles.textBox}>
                ...
                {/* 질문 3 */}
                <div className={styles.toggle}>
                  <button className={styles.btnRow} onClick={() => setBtnClick_3(!btnClick_3)}>
                    <text className={styles.contentBigText}>1년 활동이 어떻게 되나요?</text>
                    <text className={styles.contentBigText}>{btnClick_3 ? '▲' : '▼'}</text>
                  </button>
                  {btnClick_3 ? (
                    <div className={styles.textBox}>
                      <text style={{ fontSize: 18 }}>
